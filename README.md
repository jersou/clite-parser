...
import { cliteRun } from "jsr:@jersou/clite@0.7.1";
...
```typescript
import { alias, cliteRun, help } from "jsr:@jersou/clite@0.7.1";
...
```typescript
import { cliteRun, help } from "jsr:@jersou/clite@0.7.1";
...
```javascript
import { cliteParse } from "https://esm.sh/jsr/@jersou/clite@0.7.1";
