...
```typescript
import { alias, cliteRun, help } from "jsr:@jersou/clite@0.7.2";
...
```typescript
import { cliteRun, help } from "jsr:@jersou/clite@0.7.2";
...
```javascript
import { cliteParse } from "https://esm.sh/jsr/@jersou/clite@0.7.2";
